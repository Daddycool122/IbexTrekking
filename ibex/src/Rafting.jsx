...
import trekking from "./assets/home/trekking.webp";
    ...
    <>
      ...
      {/* <div className={styles.adventure_card_section}>
        ...
        <div className={styles.indi_adventure_card}>
          ...
          <div className={styles.ad_cd_price}>
            <span className={styles.ad_cd_price_main}>INR 24,999</span>
            <span className={styles.ad_cd_price_cut}>INR 26,000</span>
          </div>
          <div className={styles.ad_cd_book}>
            <a href="tel://+916396518778" className={styles.ad_cd_call}>
              <svg
      ...
      <div className={styles.adventure_card_section}>
        <div className={styles.indi_adventure_card}>
          ...
          <div className={styles.ad_cd_price}>
            <span className={styles.ad_cd_price_main}>INR 1,020</span>
