...
import img5 from "./assets/Trek/gaumukh/gaumukh-trek-1.webp";
import img6 from "./assets/Trek/kedarkantha/kedarkantha-trek-1.webp";
import img7 from "./assets/Trek/kuari/kuari-trek-2.webp";
import img9 from "./assets/Trek/pangarchulla/pangarchulla-trek-1.webp";
...
export default function Trekking() {
  ...
  useEffect(() => {
    ...
    const elements = document.querySelectorAll(`.${styles.indi_adventure_card}`);
  ...
  return (
    <>
      ...
      <h1 className={styles.title} ref={trekking_ref} style={{ textAlign: "center", margin: "2rem 0", color: "#1a1a1a", fontSize: "2.5rem" }}>
        Himalayan Treks
      ...
      {/* <div className={styles.adventure_card_section}>
        <div className={styles.indi_adventure_card}>
          <img loading="lazy" src={rafting1} className={styles.ad_cd_img} alt="16km river rafting in rishikesh" />
          <div className={styles.date_night_rating}>
          ...
          <div className={styles.ad_cd_price}>
            <span className={styles.ad_cd_price_main}>INR 800</span>
            <span className={styles.ad_cd_price_cut}>INR 1,000</span>
          </div>
          <div className={styles.ad_cd_book}>
            <a href="tel://+916396518778" className={styles.ad_cd_call}>
              <svg
        ...
        <div className={styles.indi_adventure_card}>
          <img loading="lazy" src={rafting2} className={styles.ad_cd_img} alt="25km river rafting in rishikesh" />
          <div className={styles.date_night_rating}>
          ...
          <div className={styles.ad_cd_price}>
            <span className={styles.ad_cd_price_main}>INR 1,200</span>
            <span className={styles.ad_cd_price_cut}>INR 1,600</span>
          </div>
          <div className={styles.ad_cd_book}>
            <a href="tel://+916396518778" className={styles.ad_cd_call}>
              <svg
        ...
        <div className={styles.indi_adventure_card}>
          <img loading="lazy" src={rafting3} className={styles.ad_cd_img} alt="35km river rafting in rishikesh" />
          <div className={styles.date_night_rating}>
          ...
          <div className={styles.ad_cd_price}>
            <span className={styles.ad_cd_price_main}>INR 1,600</span>
            <span className={styles.ad_cd_price_cut}>INR 2,000</span>
          </div>
          <div className={styles.ad_cd_book}>
            <a href="tel://+916396518778" className={styles.ad_cd_call}>
              <svg
