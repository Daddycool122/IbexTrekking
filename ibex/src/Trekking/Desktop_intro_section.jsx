  ...
  return (
    <>
      <div className={styles.main_intro_section}>
        <img src={img} alt="" className={styles.main_img} loading="eager" decoding="async" />
        ...
        <div className={styles.content_section}>
          ...
          >
            ...
            <div className={styles.book_now_text}>Book Now</div>
          </div>
          <div className={styles.trust_box}>
            <div className={styles.tb_images_section}>
              ...
              <img src={rating_img5} alt="" className={styles.trust_imgs_2} loading="lazy" decoding="async" />
              <img src={rating_img2} alt="" className={styles.trust_imgs_3} loading="lazy" decoding="async" />
            </div>
